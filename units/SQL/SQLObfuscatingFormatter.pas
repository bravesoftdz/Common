unit SQLObfuscatingFormatter;

interface

type
  TSqlObfuscatingFormatter = class
  public
    constructor Create; overload;
    constructor Create(RandomizeCase: Boolean; RandomizeColor, bool randomizeLineLength, bool preserveComments, bool subtituteKeywords)
  end;
