...
function SelectSingleNode(xnRoot: IXmlNode; const nodePath: WideString): IXmlNode;
...
//  NewRoot: IXMLNode;
begin
  FOwner := TComponent.Create(nil); { this object will be responsible for memory dispose }
...
begin
  if Value then
    DocumentElement.SetAttribute(SQLConstants.ANAME_ERRORFOUND, '1')
  else
    DocumentElement.SetAttributeNS('nil', SQLConstants.ANAME_ERRORFOUND, Null);
end;
(*
function SelectNodes(const FocusNode: IXMLNode; const XPath: string): IXMLNodeList;
var
