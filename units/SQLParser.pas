        ...
        begin
          ...
          IsInsertOrValuesClause := Assigned(FirstNonCommentParensSibling) and
            ...
            ( (FirstNonCommentParensSibling.NodeName = SQLConstants.ENAME_COMPOUNDKEYWORD) and
              StartsWith(FirstNonCommentParensSibling.GetAttribute(SQLConstants.ANAME_SIMPLETEXT), 'INSERT ') ) or
            ( (FirstNonCommentParensSibling.NodeName = SQLConstants.ENAME_OTHERKEYWORD) and
          ...
          begin
            ...
            begin
              ...
              TriggerConditionType.SetAttribute(SQLConstants.ANAME_SIMPLETEXT, triggerConditionTypeSimpleText);
...
begin
  ...
  if Assigned(FirstEntryOfProvidedContainer) and
    ...
    KeywordUpperValue := FirstEntryOfProvidedContainer.GetAttribute(SQLConstants.ANAME_SIMPLETEXT);
...
begin
  ...
  compoundKeyword.SetAttribute(SQLConstants.ANAME_SIMPLETEXT, targetText);
  ...
  begin
    ...
    begin
      ...
      if CurrentNode.NodeName = SQLConstants.ENAME_COMPOUNDKEYWORD then
        UppercaseText := CurrentNode.Attributes[SQLConstants.ANAME_SIMPLETEXT]
      else
